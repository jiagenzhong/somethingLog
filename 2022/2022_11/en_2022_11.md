...
You can't really recover the sleep you missed out on, but you also don't want to get neurotically attached to a schedule because there's this thing called sleep anxiety and then people have trouble falling asleep and staying asleep.  
...
in the cells of the eye that connect to the rest of the brain called melanopsin.  
...
to then set the circadian clock.  
...
How does that work? Well that's actually from dopamine
...
and we feel really good and there's a lot more breeding and breeding-like behavior.  
...
Now that's not to say that we should go back
to a time in which we didn't use artificial lights.  
But I think the important thing to realize is that feeling good with getting a lot of light,
...
luteinizing hormone, and the production of these hormones, and melatonin is the effector.  
...
You know, there are some species that literally
change shape in their reproductive organs.  
In fact, if that wasn't weird enough, when I was in graduate school at Berkeley,
...
they actually adjust the numbers of males and females depending on the density of males and females.  
...
and they look a little glassy-eyed and they're kind of looking through you or even a young child.  
...
visual image of a like a one month old.  
...
But a lot of that is clearing of the lens and some of the other aqueous features of the newborn eye,
...
of a temperature minimum and a temperature maximum.  
Their temperature minimums and maximums are fluctuating much more quickly.  

And it varies tremendously.  
Actually there's an interesting literature of whether or not they have siblings,
...
a certain amount of autonomic regulation.  
So what would this look like? This would look like, the baby goes down,
...
deliberately employed that, who don't have children for the sake of work productivity.  
...
but if you have a baby, the baby may be throwing you into that kind of schedule anyway.  
...
measured by things like positron emission tomography, etc.  
...
which can be brutal for certain people, and especially if you're trying to prepare meals and do all these things.  
So I do recognize
that there are a lot of constraints on parenting not just mapping on your baby's sleep schedule.  
...
why that could potentially be detrimental talk about that with your doctor.  
But more so trying to get longer blocks of sleep
that map onto these ultradian cycles.  
So it would be better off to get a three hour, like two-90 minute cycles, than a four hour batch of sleep
...
It's just going to set any number of other things in a better direction than were you to try to say,
...
So in other words, try and access deep calm if you can't sleep, try and access sleep, if you can sleep
...
than what I described for shift work, this is when things are really chaotic and you're just not able to sleep.  
...
Try and get sleep whenever you can but also try to get morning sunlight
...
And so there's a huge number of biological processes that are happening during puberty,
probably devote a whole episode to puberty as a fascinating aspect to the life course
but it is accelerated period of aging.  
...
Now, if that means they're sleeping until 2:00 PM, and then waking up and then they're up all night,
...
what you would find is that their temperature minimum would come later in the morning.  
...
So I think with adolescents and teens it makes sense to kind of give them a little bit more rope
in terms of allowing them some leeway to adjust their own schedule.  
...
There are data from Dr.  
Jamie Zeitzer, Department of Psychiatry and Behavioral Sciences, and others at Stanford, showing that turning on the lights
...
I talked about this on Instagram, I may talk about it again.  
...
If you want to do that you can go to thorne.  
com/u/huberman.  
