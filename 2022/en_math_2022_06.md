...
>We define $ R^n $ = all ordered n-tuples of real numbers $ (x_1, x_2 ,x_3, ..., x_n) $.  
...
For example, $ (0, \frac{3}{2}, -\pi) $ and $ (1, −2, 3) $ are points of $ R^3 $ .
...
In the [Overview](/0x00_Overview.md), we could have used $R^4$ to label the amount of traffic $(x,y,z,w)$ passing through four streets.  
