...
$\begin{cases} x+2y+3z=6 \\\ 2x-3y+2z=14 \\\ 3x+y-z=-2 \end{cases} \\\ \underrightarrow{2nd \ = \ 2nd-2 \times 1st} \begin{cases} x+2y+3z=6 \\\ -7y-4z=2 \\\ 3x+y-z=-2 \end{cases}  \\\ \underrightarrow{3rd \ = \ 3rd-3 \times 1st} \begin{cases} x+2y+3z=6 \\\ -7y-4z=2 \\\ -5y-10z=-20 \end{cases} \\\ \underrightarrow{\ 2nd \longleftrightarrow 3rd} \begin{cases} x+2y+3z=6 \\\ -5y-10z=-20 \\\ -7y-4z=2 \end{cases} \\\ \underrightarrow{divide \ 2nd \ by -5} \begin{cases} x+2y+3z=6 \\\ y+2z=4 \\\ -7y-4z=2 \end{cases} \\\ \underrightarrow{3rd \ = \ 3rd+7 \times 2nd} \begin{cases} x+2y+3z=6 \\\ y+2z=4 \\\ 10z=30 \end{cases}$
